...
export default function LandingContent() {
  ...
  return (
    <main ref={pageRef} className="overflow-hidden">
      ...
      {/* FINAL CTA */}
      <section ref={ctaRef} className="container-custom pb-28 lg:pb-36">
        <div className="relative overflow-hidden rounded-3xl border border-purple/20 bg-gradient-to-br from-purple/[0.12] via-purple/[0.04] to-green/[0.05] px-6 py-16 text-center sm:px-12 lg:py-20">
          ...
          <div className="relative">
            <div className="mx-auto mb-6 flex h-12 w-12 items-center justify-center rounded-2xl bg-purple shadow-lg shadow-purple/20">
